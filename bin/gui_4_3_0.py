...
# Form implementation generated from reading ui file 'bin/guiv4_3_0.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 250, 651))
        ...
        self.doubleSpinBoxAttenuator.setPrefix("")
        ...
        self.framePositionButtons.setMinimumSize(QtCore.QSize(400, 500))
        ...
        self.down.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("bin/down.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.down.setIcon(icon1)
        self.down.setIconSize(QtCore.QSize(60, 50))
        self.down.setAutoRepeat(False)
        self.down.setAutoExclusive(False)
        self.down.setObjectName("down")
        self.motion_grid.addWidget(self.down, 6, 1, 1, 1)
        ...
        self.motion_grid.addWidget(self.buttonSlowOmegaTurn, 6, 0, 1, 1)
        self.pushButtonZsMinus = QtWidgets.QPushButton(self.framePositionButtons)
        self.pushButtonZsMinus.setMinimumSize(QtCore.QSize(50, 50))
        self.pushButtonZsMinus.setMaximumSize(QtCore.QSize(50, 50))
        self.pushButtonZsMinus.setToolTip("")
        self.pushButtonZsMinus.setToolTipDuration(-1)
        self.pushButtonZsMinus.setObjectName("pushButtonZsMinus")
        self.motion_grid.addWidget(self.pushButtonZsMinus, 0, 1, 1, 1)
        ...
        self.motion_grid.addWidget(self.pushButtonZPlus, 2, 0, 1, 1)
        ...
        self.motion_grid.addWidget(self.buttonFastOmegaTurn, 6, 2, 1, 1)
        self.pushButtonZsPlus = QtWidgets.QPushButton(self.framePositionButtons)
        self.pushButtonZsPlus.setMinimumSize(QtCore.QSize(50, 50))
        self.pushButtonZsPlus.setMaximumSize(QtCore.QSize(50, 50))
        self.pushButtonZsPlus.setObjectName("pushButtonZsPlus")
        self.motion_grid.addWidget(self.pushButtonZsPlus, 0, 0, 1, 1)
        self.minus90 = QtWidgets.QPushButton(self.framePositionButtons)
        self.minus90.setObjectName("minus90")
        self.motion_grid.addWidget(self.minus90, 9, 2, 1, 1)
        self.spinBoxZJogAmount = QtWidgets.QSpinBox(self.framePositionButtons)
        self.spinBoxZJogAmount.setProperty("value", 10)
        self.spinBoxZJogAmount.setObjectName("spinBoxZJogAmount")
        self.motion_grid.addWidget(self.spinBoxZJogAmount, 2, 2, 1, 1)
        self.zeroAll = QtWidgets.QPushButton(self.framePositionButtons)
        self.zeroAll.setMinimumSize(QtCore.QSize(60, 60))
        self.zeroAll.setMaximumSize(QtCore.QSize(80, 80))
        self.zeroAll.setFlat(False)
        self.zeroAll.setObjectName("zeroAll")
        self.motion_grid.addWidget(self.zeroAll, 4, 1, 1, 1)
        ...
        self.left.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("bin/left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.left.setIcon(icon2)
        self.left.setIconSize(QtCore.QSize(50, 60))
        self.left.setObjectName("left")
        self.motion_grid.addWidget(self.left, 4, 0, 1, 1)
        self.doubleSpinBoxOmegaJog = QtWidgets.QDoubleSpinBox(self.framePositionButtons)
        self.doubleSpinBoxOmegaJog.setDecimals(1)
        self.doubleSpinBoxOmegaJog.setMaximum(3600.0)
        self.doubleSpinBoxOmegaJog.setStepType(QtWidgets.QAbstractSpinBox.DefaultStepType)
        self.doubleSpinBoxOmegaJog.setProperty("value", 5.0)
        self.doubleSpinBoxOmegaJog.setObjectName("doubleSpinBoxOmegaJog")
        self.motion_grid.addWidget(self.doubleSpinBoxOmegaJog, 11, 0, 1, 1)
        ...
        self.pushButtonZMinus.setToolTip("")
        self.pushButtonZMinus.setObjectName("pushButtonZMinus")
        self.motion_grid.addWidget(self.pushButtonZMinus, 2, 1, 1, 1)
        ...
        self.up.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("bin/up.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.up.setIcon(icon3)
        self.up.setIconSize(QtCore.QSize(60, 50))
        self.up.setObjectName("up")
        self.motion_grid.addWidget(self.up, 3, 1, 1, 1)
        ...
        self.right.setIconSize(QtCore.QSize(50, 60))
        self.right.setObjectName("right")
        self.motion_grid.addWidget(self.right, 4, 2, 1, 1)
        self.plus15 = QtWidgets.QPushButton(self.framePositionButtons)
        self.plus15.setObjectName("plus15")
        self.motion_grid.addWidget(self.plus15, 10, 1, 1, 1)
        self.minus5 = QtWidgets.QPushButton(self.framePositionButtons)
        self.minus5.setObjectName("minus5")
        self.motion_grid.addWidget(self.minus5, 9, 0, 1, 1)
        self.zero = QtWidgets.QPushButton(self.framePositionButtons)
        self.zero.setObjectName("zero")
        self.motion_grid.addWidget(self.zero, 11, 2, 1, 1)
        self.plus5 = QtWidgets.QPushButton(self.framePositionButtons)
        self.plus5.setObjectName("plus5")
        self.motion_grid.addWidget(self.plus5, 10, 0, 1, 1)
        self.plus180 = QtWidgets.QPushButton(self.framePositionButtons)
        self.plus180.setObjectName("plus180")
        self.motion_grid.addWidget(self.plus180, 10, 3, 1, 1)
        self.pushButtonZsZero = QtWidgets.QPushButton(self.framePositionButtons)
        self.pushButtonZsZero.setMaximumSize(QtCore.QSize(60, 50))
        self.pushButtonZsZero.setObjectName("pushButtonZsZero")
        self.motion_grid.addWidget(self.pushButtonZsZero, 0, 3, 1, 1)
        self.spinBoxZsJogAmount = QtWidgets.QSpinBox(self.framePositionButtons)
        self.spinBoxZsJogAmount.setMaximum(5000)
        self.spinBoxZsJogAmount.setSingleStep(1)
        self.spinBoxZsJogAmount.setProperty("value", 500)
        self.spinBoxZsJogAmount.setObjectName("spinBoxZsJogAmount")
        self.motion_grid.addWidget(self.spinBoxZsJogAmount, 0, 2, 1, 1)
        ...
        self.labPresetShapeFile = QtWidgets.QLabel(self.gridFrame_3)
        self.labPresetShapeFile.setMaximumSize(QtCore.QSize(16777215, 30))
        self.labPresetShapeFile.setObjectName("labPresetShapeFile")
        self.gridLayoutCanvsMode.addWidget(self.labPresetShapeFile, 3, 1, 1, 1)
        self.pushButtonClear = QtWidgets.QPushButton(self.gridFrame_3)
        self.pushButtonClear.setObjectName("pushButtonClear")
        self.gridLayoutCanvsMode.addWidget(self.pushButtonClear, 4, 0, 1, 1)
        self.labRTC6Acquired = QtWidgets.QLabel(self.gridFrame_3)
        self.labRTC6Acquired.setMaximumSize(QtCore.QSize(100, 60))
        self.labRTC6Acquired.setAlignment(QtCore.Qt.AlignCenter)
        self.labRTC6Acquired.setObjectName("labRTC6Acquired")
        self.gridLayoutCanvsMode.addWidget(self.labRTC6Acquired, 5, 0, 1, 1)
        ...
        self.stagex_rbv = QtWidgets.QLabel(self.formFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.stagex_rbv.sizePolicy().hasHeightForWidth())
        self.stagex_rbv.setSizePolicy(sizePolicy)
        self.stagex_rbv.setMaximumSize(QtCore.QSize(90, 16777215))
        self.stagex_rbv.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.stagex_rbv.setObjectName("stagex_rbv")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.stagex_rbv)
        self.labY = QtWidgets.QLabel(self.formFrame)
        self.labY.setAlignment(QtCore.Qt.AlignCenter)
        self.labY.setObjectName("labY")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labY)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.gony_rbv)
        self.labZ = QtWidgets.QLabel(self.formFrame)
        self.labZ.setAlignment(QtCore.Qt.AlignCenter)
        self.labZ.setObjectName("labZ")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.labZ)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.gonz_rbv)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.labOmega)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.omega_rbv)
        self.labStageX = QtWidgets.QLabel(self.formFrame)
        self.labStageX.setObjectName("labStageX")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.labStageX)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 2086, 31))
        ...
        self.actionGetRTC = QtWidgets.QAction(MainWindow)
        self.actionGetRTC.setCheckable(False)
        self.actionGetRTC.setObjectName("actionGetRTC")
        self.actionReseaseRTC6 = QtWidgets.QAction(MainWindow)
        self.actionReseaseRTC6.setObjectName("actionReseaseRTC6")
        self.actionReseaseRTC6_2 = QtWidgets.QAction(MainWindow)
        self.actionReseaseRTC6_2.setObjectName("actionReseaseRTC6_2")
        ...
        self.menuRTC.addAction(self.actionGetRTC)
        self.menuRTC.addAction(self.actionReseaseRTC6_2)
        self.menuBar.addAction(self.menuFile.menuAction())
        self.menuBar.addAction(self.menuIOCs.menuAction())
        self.menuBar.addAction(self.menuRTC.menuAction())

        self.retranslateUi(MainWindow)
        self.tabWidget_robot_laser.setCurrentIndex(1)
        ...
        MainWindow.setTabOrder(self.stop, self.left)
        MainWindow.setTabOrder(self.left, self.right)
        MainWindow.setTabOrder(self.right, self.minus5)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Aithre v4.3 - I23 Laser Shaping"))
        ...
        self.doubleSpinBoxAttenuator.setSuffix(_translate("MainWindow", "%"))
        ...
        self.pushButtonZsMinus.setText(_translate("MainWindow", "Z(s)-"))
        self.pushButtonZPlus.setText(_translate("MainWindow", "Z+"))
        self.buttonFastOmegaTurn.setText(_translate("MainWindow", "Fast Turn"))
        self.pushButtonZsPlus.setText(_translate("MainWindow", "Z(s)+"))
        self.minus90.setText(_translate("MainWindow", "-90°"))
        self.spinBoxZJogAmount.setSuffix(_translate("MainWindow", "um"))
        self.zeroAll.setText(_translate("MainWindow", "ZeroAll"))
        self.doubleSpinBoxOmegaJog.setSuffix(_translate("MainWindow", "°"))
        self.pushButtonZMinus.setText(_translate("MainWindow", "Z-"))
        self.plus15.setText(_translate("MainWindow", "+15°"))
        self.minus5.setText(_translate("MainWindow", "-"))
        self.zero.setText(_translate("MainWindow", "0"))
        self.plus5.setText(_translate("MainWindow", "+"))
        self.plus180.setText(_translate("MainWindow", "+180°"))
        self.pushButtonZsZero.setText(_translate("MainWindow", "Z(s) 0"))
        self.spinBoxZsJogAmount.setSuffix(_translate("MainWindow", "um"))
        ...
        self.comboBoxSpeed.setCurrentText(_translate("MainWindow", "0.005 m/s"))
        self.comboBoxSpeed.setItemText(0, _translate("MainWindow", "0.005 m/s"))
        self.comboBoxSpeed.setItemText(1, _translate("MainWindow", "0.01 m/s"))
        self.comboBoxSpeed.setItemText(2, _translate("MainWindow", "0.05 m/s"))
        self.comboBoxSpeed.setItemText(3, _translate("MainWindow", "0.1 m/s"))
        self.comboBoxSpeed.setItemText(4, _translate("MainWindow", "0.5 m/s"))
        self.comboBoxSpeed.setItemText(5, _translate("MainWindow", "1 m/s"))
        self.comboBoxSpeed.setItemText(6, _translate("MainWindow", "2 m/s"))
        self.comboBoxSpeed.setItemText(7, _translate("MainWindow", "4 m/s"))
        ...
        self.labPresetShapeFile.setText(_translate("MainWindow", "None"))
        self.pushButtonClear.setText(_translate("MainWindow", "Clear"))
        self.labRTC6Acquired.setText(_translate("MainWindow", "RTC6"))
        self.labstageZ.setText(_translate("MainWindow", "Stage Z"))
        self.stagez_rbv.setText(_translate("MainWindow", "0.352"))
        self.stagex_rbv.setText(_translate("MainWindow", "0.111"))
        ...
        self.labStageX.setText(_translate("MainWindow", "Stage X"))
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.menuIOCs.setTitle(_translate("MainWindow", "IOCs"))
        self.menuRTC.setTitle(_translate("MainWindow", "RTC6"))
        ...
        self.actionGetRTC.setText(_translate("MainWindow", "Acquire RTC6"))
        self.actionReseaseRTC6.setText(_translate("MainWindow", "ReseaseRTC6"))
        self.actionReseaseRTC6_2.setText(_translate("MainWindow", "Resease RTC6"))
