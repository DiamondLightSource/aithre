...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labstageX = QtWidgets.QLabel(self.frameFineControl)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred
        )
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labstageX.sizePolicy().hasHeightForWidth())
        self.labstageX.setSizePolicy(sizePolicy)
        self.labstageX.setAlignment(QtCore.Qt.AlignCenter)
        self.labstageX.setObjectName("labstageX")
        self.readback_grid.addWidget(self.labstageX, 3, 0, 1, 1)
